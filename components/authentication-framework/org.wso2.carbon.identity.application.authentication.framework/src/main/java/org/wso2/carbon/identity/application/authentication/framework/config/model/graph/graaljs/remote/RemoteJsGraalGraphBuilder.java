...
public class RemoteJsGraalGraphBuilder extends JsGraphBuilder {
    ...
    // =============================================================================================
    // Script evaluation — initial and callback paths
    // =============================================================================================
     ...
     * Handles both GraalSerializableJsFunction instances and String-serialized function sources
     * from the remote sidecar.
     *
