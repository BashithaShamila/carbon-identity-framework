...
public final class RemoteEngineConstants {
    ...
    public static final String MTLS_CERT_DIR = "repository/resources/security/graaljs";

    /** Client certificate filename (PEM). */
    public static final String MTLS_CLIENT_CERT = "client.pem";
