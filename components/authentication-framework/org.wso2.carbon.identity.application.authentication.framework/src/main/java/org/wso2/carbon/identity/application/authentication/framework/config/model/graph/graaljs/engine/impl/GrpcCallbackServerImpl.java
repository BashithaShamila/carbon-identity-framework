 ...
 *
 * See: com.wso2.identity.asgardeo.scope.service.graaljs.transport.GrpcCallbackServerImpl
 */
@Deprecated
public class GrpcCallbackServerImpl {
    private GrpcCallbackServerImpl() {
